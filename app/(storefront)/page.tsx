...
/**
 * BIBAZ — Ultimate 10x Luxury Homepage (Premium v3.1)
 * Layout order (user-directed):
 *   1. Cinematic Hero Slider
 *   2. Trust Badges (2-col × 2-row)
 *   3. Category Grid (4-col, all collection images + links)
 *   4. Editorial Split Promo
 *   5. New Arrivals Grid
 *   6. Lookbook / Trend Board
 *   7. All Collections Visual Showcase (images + links — New Arrivals, Eid, etc.)
 *   8. Testimonials
 *   — Footer handles newsletter + brand story —
 */
...
/* All Collections showcase data (images + links) */
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col bg-[#fdfcfa] overflow-hidden">
      ...
      {/* ═══════════════════════════════════════════
         2. TRUST BADGES — 2 columns × 2 rows
         ═══════════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════════
         3. CATEGORY GRID — 4 columns (all collection images)
         Right after hero banner
         ═══════════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════════
         ...
         Shows collection images with links (New Arrivals, Eid, etc.)
         ═══════════════════════════════════════════ */}
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-16 max-w-7xl">
          ...
          <div className="text-center max-w-lg mx-auto mb-14 md:mb-16">
            ...
            <p className="text-xs text-muted-foreground mt-4 max-w-md mx-auto leading-relaxed">
              From festive Eid ensembles to everyday modest wear — discover every curated collection
              in one place.
            </p>
          </div>
      ...
      {/* ═══════════════════════════════════════════
         8. EDITORIAL ASYMMETRICAL SPLIT PROMO (Our Story)
         ═══════════════════════════════════════════ */}
