...
// Coupon Codes (SOP §৬ — Frontend Demo Coupons)
// type: "percent" = % off subtotal | "flat" = flat BDT off
export const COUPON_CODES: Record<
  string,
  { type: "percent" | "flat"; value: number; label: string }
> = {
  BIBAZ10: { type: "percent", value: 10, label: "10% off your order" },
  BIBAZ20: { type: "percent", value: 20, label: "20% off your order" },
